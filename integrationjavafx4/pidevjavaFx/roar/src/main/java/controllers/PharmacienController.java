...
public class PharmacienController {
    ...
    @   assignable this.pharmacien;
    @   ensures this.pharmacien == pharmacien;
    @*/

    public void setUtilisateur(Pharmacien pharmacien) {
    ...
    private void handleEnregistrer() {
        try {
            ...
            userService.ajouterUtilisateur(pharmacien, "pharmacien");

            // Afficher une confirmation
            showAlert(Alert.AlertType.INFORMATION, "Succès", "Pharmacien créé avec succès !");
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur", "Erreur lors de la création du pharmacien : " + e.getMessage());
        } catch (IOException e) {
