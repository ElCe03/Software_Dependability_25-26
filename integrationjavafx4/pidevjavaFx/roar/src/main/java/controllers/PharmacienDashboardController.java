...
public class PharmacienDashboardController {
    ...
    @   requires event != null;
    @   requires event.getSource() instanceof Hyperlink;
    @   assignable \nothing;
    @ also
    ...
    @FXML
    private void handlemedicament(ActionEvent event) {
        try {
            // Load the front.fxml file
            Parent frontPage = FXMLLoader.load(getClass().getResource("/medicament_list.fxml"));
            Scene frontScene = new Scene(frontPage);
